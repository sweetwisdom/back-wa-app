...
// provider intentionally does not synthesize trust material; callers must inject
// a capture produced by the matching APK/native implementation when available.
